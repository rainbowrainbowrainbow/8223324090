...
- Release package baseline prepared for this handoff: `0.81.102` (`Продукти · Каталоги · Конструктор випускного`).
- Release `0.81.102` is the package baseline prepared in this handoff.
