...
checkPage('customers.html', (doc, html) => {
    ...
    check('Customer list mobile layout removes horizontal table scanning without hiding open-card action', customerPageCss.includes('@media (max-width: 640px)') && customerPageCss.includes('grid-template-areas:') && customerPageCss.includes('"identity phone"') && customerPageCss.includes('"last visits"') && customerPageCss.includes('.customer-list-cell--secondary') && customerPageCss.includes('display: none') && customerPageCss.includes('.customer-list-table .customer-name') && customerPageCss.includes('overflow-wrap: anywhere'));
