...
checkPage('reports.html', (doc, html) => {
    ...
    check('Reports builder exposes stable management state controls', !!doc.getElementById('reportSheetTitleInput') && !!doc.getElementById('reportSheetModeChip') && !!doc.getElementById('reportTemplateDirty') && reportsCode.includes('function refreshReportWorkspaceControls') && reportsCode.includes('function validateReportTableForCreate'));
