...
- Release package baseline prepared for this handoff: `0.81.110` (`Профілі ЗП: доступність і CI smoke`).
- Release `0.81.110` is the package baseline prepared in this handoff.
