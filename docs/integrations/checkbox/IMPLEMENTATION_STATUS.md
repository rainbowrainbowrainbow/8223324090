...
- Release package baseline prepared for this handoff: `0.81.120` (`Omni: ручне створення ліда`).
- Release `0.81.120` is the package baseline prepared in this handoff.
