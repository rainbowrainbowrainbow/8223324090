...
- Release package baseline prepared for this handoff: `0.82.12` (`Staff Account Handoff Fail-Closed`).
- Release `0.82.12` is the package baseline prepared in this handoff.
