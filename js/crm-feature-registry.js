    ...
    const FEATURES = [
        {
            ...
            title: 'Видати сертифікат або абонемент',
            href: '/certificates/new',
            icon: '🎫',
            access: 'certificates',
            group: 'product',
            breadcrumb: 'Сертифікати -> Видати сертифікат або абонемент',
            summary: 'Окрема сторінка для видачі одного сертифіката або абонемента.',
            primaryAction: 'Відкрити видачу',
            aliases: [
                'видати сертифікат',
                'видати абонемент',
                'створити абонемент',
                'сертифікат або абонемент',
                'створити сертифікат',
                'новий сертифікат',
                'видати грамоту',
                'створити грамоту',
