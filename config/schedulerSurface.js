const GUARDED_SCHEDULER_JOBS = [
    ...
    { name: 'checkTaskReminders', functionName: 'checkTaskReminders', sourceFile: 'services/scheduler.js', owner: 'tasks', interval: '60000', dedup: 'hourly', sideEffects: ['telegram', 'database'], tests: ['tests/scheduler-notification-jobs-hardening.test.js'] },
