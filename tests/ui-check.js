...
checkPage('staff.html', (doc, html) => {
    ...
    check('Staff schedule keeps premium HR Pulse switcher and unified panel rhythm',
        ...
        && html.includes('js/staff-schedule-shell.js?v=0.79.33')
        && html.includes('js/hr-pulse-switcher.js?v=0.79.33')
...
check('HR access editor and onboarding wizard persist extraRoles as real working-role grants',
    hrCode.includes('Це реальні extraRoles акаунта')
    && hrCode.includes('const extraRoles = normalizeAccountListInput(formResult.extraRoles)')
...
check('HR grouped IA keeps Pulse clean and vacancy workspace owns hiring surfaces',
    ...
    && htmlContains('hr.html', 'js/hr-pulse-switcher.js?v=0.79.33')
    ...
    && htmlContains('hr.html', 'js/staff-schedule-shell.js?v=0.79.33')
    && htmlContains('hr.html', 'js/staff-page.js?v=0.79.33')
...
check('HR Salary and KPI use responsive master-detail lists without wide Payroll tables', htmlContains('hr.html', 'id="salaryList" class="hr-payroll-list"') && htmlContains('hr.html', 'id="kpiList" class="hr-payroll-list"') && !htmlContains('hr.html', 'id="salaryHead"') && !htmlContains('hr.html', 'id="salaryBody"') && !htmlContains('hr.html', 'id="kpiHead"') && !htmlContains('hr.html', 'id="kpiBody"') && hrCode.includes('function renderSalaryEmployeeItem') && hrCode.includes('function renderKpiEmployeeItem') && hrCode.includes('function bindPayrollDetailToggles') && hrCode.includes('data-payroll-detail-toggle') && hrCode.includes('renderSalaryRateSummary(s)') && hrCode.includes('${daysWorked} дн · ${hoursWorked} год') && hrPageCss.includes('@media (max-width: 1200px)') && hrPageCss.includes('#tab-salary .hr-payroll-salary-summary') && hrPageCss.includes('#tab-kpi .hr-payroll-kpi-summary') && hrPageCss.includes('#tab-salary .hr-payroll-detail-toggle') && hrPageCss.includes('min-height: 44px;'));
