...
check('Sidebar additional menu uses a simple CRM page checklist editor', sidebarCode.includes('EXTRA_MENU_STORAGE_KEY') && sidebarCode.includes('_getSelectableExtraMenuItems') && sidebarCode.includes('_saveExtraMenuSelection') && sidebarCode.includes('data-sidebar-extra-picker') && sidebarCode.includes('data-sidebar-extra-page') && sidebarCode.includes('data-sidebar-extra-save') && sidebarCode.includes('data-sidebar-extra-reset') && sidebarCode.includes('data-sidebar-extra-clear') && !sidebarCode.includes('data-sidebar-extra-form') && !sidebarCode.includes('data-sidebar-extra-edit=') && !sidebarCode.includes('data-sidebar-extra-delete') && !sidebarCode.includes('Notion · daily ops') && !sidebarCode.includes('calendar.google.com') && !sidebarCode.includes('web.monobank.ua'));
...
check('Sidebar quick access editor saves explicitly and can add all CRM pages', sidebarCode.includes('data-sidebar-extra-select-all') && sidebarCode.includes('data-sidebar-extra-search') && sidebarCode.includes('data-sidebar-extra-count') && sidebarCode.includes('_applyExtraMenuEditorFilter') && sidebarCode.includes('_setExtraMenuEditorOpen(false)') && sidebarAuroraCss.includes('.sidebar-extra-editor-tools') && sidebarAuroraCss.includes('.sidebar-extra-search') && sidebarAuroraCss.includes('.sidebar-extra-secondary'));
