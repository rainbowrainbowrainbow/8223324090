...
const SEARCH_NAV_ALIASES = {
    ...
    '/omni?telView=all': ['телефонія', 'дзвінки', 'binotel', 'журнал дзвінків', 'пропущені дзвінки'],
    ...
    '/certificates/new': ['видати сертифікат', 'видати абонемент', 'сертифікат або абонемент', 'new certificate', 'new subscription', 'створити сертифікат', 'створити абонемент', 'видати грамоту', 'створити грамоту', 'грамота', 'грамоту'],
...
const SEARCH_FALLBACK_NAV_ITEMS = [
    ...
    { href: '/omni?telView=all', icon: '☎', label: 'Телефонія', access: 'omni', group: 'sales' },
