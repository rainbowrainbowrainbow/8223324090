...
- Release package baseline prepared for this handoff: `0.81.152` (`Рішення щодо legacy-матеріалів Design Board`).
- Release `0.81.152` is the package baseline prepared in this handoff.
