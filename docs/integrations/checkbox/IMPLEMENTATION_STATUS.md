...
- Release package baseline prepared for this handoff: `0.81.143` (`Omni: безпечний Viber bridge`).
- Release `0.81.143` is the package baseline prepared in this handoff.
