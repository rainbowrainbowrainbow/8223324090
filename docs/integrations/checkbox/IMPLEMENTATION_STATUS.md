...
- Release package baseline prepared for this handoff: `0.81.190` (`Omni: мобільний список чатів`).
- Release `0.81.190` is the package baseline prepared in this handoff.
