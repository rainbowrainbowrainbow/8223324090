...
check('Shared assistant rail has animated face, glasses, and dot-constellation presence states', assistantRailCode.includes('assistant-rail-dot-cloud') && assistantRailCode.includes('assistant-rail-face') && assistantRailCode.includes('assistant-rail-glasses') && assistantRailCss.includes('v0.57.2: assistant presence constellation') && assistantRailCss.includes('@keyframes assistantDotPulse') && assistantRailCss.includes('assistantMouthSpeak') && ['thinking', 'listening', 'streaming', 'action', 'success', 'error'].every(state => assistantRailCss.includes(`[data-ai-state="${state}"] .assistant-rail-dot`)));
...
check('Shared assistant rail clips duplicate avatar decoration away from title text', assistantRailCss.includes('v0.58.4: assistant avatar collision guard') && assistantRailCss.includes('grid-template-columns: 54px minmax(0, 1fr) !important') && assistantRailCss.includes('.crm-assistant-rail .assistant-rail-avatar::before') && assistantRailCss.includes('.crm-assistant-rail .assistant-rail-particle-field') && assistantRailCss.includes('display: none !important') && assistantRailCss.includes('overflow: hidden !important') && assistantRailCss.includes('isolation: isolate !important'));
