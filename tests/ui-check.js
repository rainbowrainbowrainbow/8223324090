...
checkPage('index.html', (doc, html) => {
    ...
    const timelineCompactCommandCss = sourceBlock(
        ...
        '/* v0.77.81: filters expand inline in the compact date command line. */'
    );
    ...
    check('Timeline header keeps view panel, ordered topbar actions, and a utility-row view trigger',
        ...
        && htmlContains('css/responsive.css', 'v0.77.81: filters expand inline in the compact date command line.')
    ...
    check('Timeline header regression guard forbids old search, compact, label, and second-row contracts',
        ...
        && timelineViewPanelRule.includes('max-inline-size: min(100%, calc(100vw - 48px))')
        ...
        && timelineInlineViewPanelRule.includes('max-width: min(100%, calc(100vw - 48px)) !important')
        && timelineViewPanelRule.includes('overflow: visible')
    ...
    check('Timeline view panel filter toolbar is theme-aware without losing light active tokens',
        ...
        && timelineHeaderFiltersRule.includes('background: transparent')
        && timelineHeaderFiltersRule.includes('border: 0')
        && timelineViewPanelRule.includes('background: transparent')
        && timelineViewPanelRule.includes('border: 0')
        && timelineViewPanelRule.includes('box-shadow: none')
        && htmlContains('css/responsive.css', '--timeline-header-filter-control-bg: var(--eg-panel-bg-soft')
        && htmlContains('css/responsive.css', '--timeline-header-filter-border: var(--eg-border-default')
    ...
    check('Timeline view panel expands inline in the date command row',
        ...
        && timelineViewPanelRule.includes('max-width: min(100%, calc(100vw - 48px))')
        && timelineInlineViewPanelRule.includes('position: static !important')
        && timelineInlineViewPanelRule.includes('inset: auto !important')
        && timelineInlineViewPanelRule.includes('top: auto !important')
        && timelineInlineViewPanelRule.includes('width: max-content !important')
        && timelineInlineViewPanelRule.includes('max-inline-size: min(100%, calc(100vw - 48px)) !important')
        && timelineViewPanelHiddenRule.includes('display: none !important')
    ...
    check('Timeline inline filter controls and topbar actions have an overflow-safe contract',
    ...
    check('Timeline browser smoke guards header visibility and 15-minute geometry thresholds',
        ...
        && timelineBrowserSmokeCode.includes('openMetrics.viewPanelTop >= openMetrics.utilityRowTop - 1')
        && timelineBrowserSmokeCode.includes('openMetrics.viewPanelBottom <= openMetrics.timelineTop + 1')
        && timelineBrowserSmokeCode.includes('opening filters keeps a compact command line')
        && timelineBrowserSmokeCode.includes('open filters stay above the timeline grid')
        && timelineBrowserSmokeCode.includes('openMetrics.viewPanelWidth <= openMetrics.viewportWidth + 1')
        && timelineBrowserSmokeCode.includes('openMetrics.viewPanelHeight <= 64')
