...
- Release package baseline prepared for this handoff: `0.81.116` (`HR чеклісти: повернення фокуса`).
- Release `0.81.116` is the package baseline prepared in this handoff.
