...
- Release package baseline prepared for this handoff: `0.81.109` (`PARK/DAR: каса та обробка чеків`).
- Release `0.81.109` is the package baseline prepared in this handoff.
