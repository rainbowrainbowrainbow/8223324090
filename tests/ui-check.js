...
check('CRM assistant flagship core pages have actions and guided flows', ['dashboard.work-queue-review', 'tasks.overdue-review', 'finance.debt-review', 'leads.follow-up-review', 'chat.unread-review', 'dashboard.focus-work-queue', 'tasks.focus-overdue', 'finance.open-debts', 'leads.focus-hot', 'chat.filter-unread'].every(token => assistantFoundationCode.includes(token)));
