...
check('Timeline labels split Park and MD while MD hides Park Afisha', sidebarCode.includes("label: 'Таймлайн ПАРК'") && sidebarCode.includes("label: 'Таймлайн МД'") && featureRegistryCode.includes("title: 'Таймлайн ПАРК'") && featureRegistryCode.includes("title: 'Таймлайн МД'") && searchCode.includes("label: 'Таймлайн ПАРК'") && searchCode.includes("label: 'Таймлайн МД'") && htmlContains('js/timeline-context.js', 'showAfisha: false') && htmlContains('js/timeline.js', 'function timelineShouldRenderAfisha') && htmlContains('js/timeline.js', 'showAfisha ? apiGetAfishaByDate') && htmlContains('js/timeline.js', 'const allAfisha = showAfisha ? (afishaEvents || []) : []') && htmlContains('js/timeline.js', 'function normalizeTimelineLinesForContext') && htmlContains('routes/lines.js', "name: 'Таймлайн МД'"));
