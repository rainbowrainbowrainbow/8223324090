...
- Release package baseline prepared for this handoff: `0.81.4` (`AI task draft normalization + telemetry`).
...
- Release `0.81.4` is the package baseline prepared in this handoff. Reconfirm live version/commit before any future delivery or activation action.
