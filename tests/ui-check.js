...
check('Sidebar additional menu uses a simple CRM page checklist editor', sidebarCode.includes('EXTRA_MENU_STORAGE_KEY') && sidebarCode.includes('_getSelectableExtraMenuItems') && sidebarCode.includes('_saveExtraMenuSelection') && sidebarCode.includes('data-sidebar-extra-picker') && sidebarCode.includes('data-sidebar-extra-page') && sidebarCode.includes('data-sidebar-extra-reset') && sidebarCode.includes('data-sidebar-extra-clear') && !sidebarCode.includes('data-sidebar-extra-form') && !sidebarCode.includes('data-sidebar-extra-edit=') && !sidebarCode.includes('data-sidebar-extra-delete') && !sidebarCode.includes('Notion · daily ops') && !sidebarCode.includes('calendar.google.com') && !sidebarCode.includes('web.monobank.ua'));
