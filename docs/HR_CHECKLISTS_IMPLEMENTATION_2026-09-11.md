...
## Підготовка кандидата до публікації
...
Push, remote CI та deploy цього HR-кандидата не виконані. Окремий version/cache commit створюється контролером під час дозволеного release-блоку; не слід повторно підвищувати версію вручну перед його запуском. Актуальні результати повторного прогону та manifest наведені в `HR_CHECKLISTS_RELEASE_PREP_2026-09-11.md`.

## Історія реалізації та локального аудиту
