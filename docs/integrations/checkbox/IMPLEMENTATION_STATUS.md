...
- Release package baseline prepared for this handoff: `0.81.81` (`Redirect Watchdog Old-Tab Recovery`).
- Release `0.81.81` is the package baseline prepared in this handoff.
