...
- Release package baseline prepared for this handoff: `0.82.6` (`Omni: зрозумілий Facebook fallback`).
- Release `0.82.6` is the package baseline prepared in this handoff.
