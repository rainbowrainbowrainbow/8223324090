...
ALTER TABLE business_cutover_journal
    DROP CONSTRAINT IF EXISTS business_cutover_journal_approval_ref_check;
ALTER TABLE business_cutover_journal
...
ALTER TABLE business_cutover_journal
    DROP CONSTRAINT IF EXISTS business_cutover_journal_source_fingerprint_check;
ALTER TABLE business_cutover_journal
...
ALTER TABLE business_cutover_journal
    DROP CONSTRAINT IF EXISTS business_cutover_journal_receipt_hash_check;
ALTER TABLE business_cutover_journal
