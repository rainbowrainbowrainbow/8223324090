...
- Release package baseline prepared for this handoff: `0.81.25` (`Scheduler Direct Behavior Closure`).
...
- Release `0.81.25` is the package baseline prepared in this handoff.
