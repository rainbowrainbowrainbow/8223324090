/**
 * services/telegram.js — Telegram Bot API wrapper + notification logic
 *
 * SRP: все що стосується Telegram — запити до API, відправка/редагування/видалення,
 * автоматичні повідомлення, кеш токена.
 * Не знає про Express routing.
 */
