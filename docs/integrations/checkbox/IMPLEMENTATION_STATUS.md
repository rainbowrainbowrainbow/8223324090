...
- Release package baseline prepared for this handoff: `0.82.16` (`HR Парку: картка команди та стани переходів`).
- Release `0.82.16` is the package baseline prepared in this handoff.
