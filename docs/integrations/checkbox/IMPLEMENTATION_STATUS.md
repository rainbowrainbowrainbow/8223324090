...
- Release package baseline prepared for this handoff: `0.81.198` (`Omni: WhatsApp шаблони після 24 годин`).
- Release `0.81.198` is the package baseline prepared in this handoff.
