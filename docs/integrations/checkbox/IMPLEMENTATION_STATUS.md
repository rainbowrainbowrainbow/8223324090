...
- Release package baseline prepared for this handoff: `0.81.135` (`Dashboard: видимість і мобільний fallback`).
- Release `0.81.135` is the package baseline prepared in this handoff.
