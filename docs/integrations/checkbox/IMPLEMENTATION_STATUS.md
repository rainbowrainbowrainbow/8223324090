...
- Release package baseline prepared for this handoff: `0.81.154` (`Гайдбук Design Board для реклами`).
- Release `0.81.154` is the package baseline prepared in this handoff.
