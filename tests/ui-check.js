...
check('Sidebar status rail uses large custom icons and readable floating descriptions', sidebarCode.includes('function _renderStatusIcon') && sidebarCode.includes('data-sidebar-tooltip') && sidebarCode.includes('function _initPillTooltips') && sidebarCode.includes('sidebarPillTooltip') && sidebarAuroraCss.includes('.sidebar-status-svg') && sidebarAuroraCss.includes('.sidebar-pill::after') && sidebarAuroraCss.includes('content: none !important') && sidebarAuroraCss.includes('.sidebar-pill-tooltip') && sidebarAuroraCss.includes('position: fixed'));
check('Sidebar exposes a separate dashboard jump above the accordion list', sidebarCode.includes('function _ensureDashboardJump') && sidebarCode.includes('sidebarDashboardJumpWrap') && sidebarCode.includes('sidebar.insertBefore(wrap, links)') && sidebarAuroraCss.includes('.sidebar-dashboard-jump-wrap') && sidebarAuroraCss.includes('.sidebar-dashboard-jump.active'));
