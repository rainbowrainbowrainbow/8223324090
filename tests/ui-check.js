...
checkPage('staff.html', (doc, html) => {
    ...
    check('Staff schedule keeps premium HR Pulse switcher and unified panel rhythm',
        ...
        && html.includes('js/staff-schedule-shell.js?v=0.80.98')
        && html.includes('js/hr-pulse-switcher.js?v=0.80.98')
...
check('HR grouped IA keeps Pulse clean and vacancy workspace owns hiring surfaces',
    ...
    && htmlContains('hr.html', 'js/hr-pulse-switcher.js?v=0.80.98')
    ...
    && htmlContains('hr.html', 'js/staff-schedule-shell.js?v=0.80.98')
    && htmlContains('hr.html', 'js/staff-page.js?v=0.80.98')
...
check('HR Account Center uses the dedicated effective-access workspace',
    htmlContains('hr.html', 'css/account-access-editor.css?v=0.80.98')
    && htmlContains('hr.html', 'js/account-access-editor.js?v=0.80.98')
