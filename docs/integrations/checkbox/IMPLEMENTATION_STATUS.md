...
- Release package baseline prepared for this handoff: `0.81.197` (`Omni: адаптивність і browser QA`).
- Release `0.81.197` is the package baseline prepared in this handoff.
