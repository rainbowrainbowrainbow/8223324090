...
> Створено: 2026-02-22. Статус: **ПЛАН** (не реалізовано)
...
## 6. ЩО НЕ ВХОДИТЬ В v1 (на потім)

- Окрема сторінка CRM (`customers.html`)
- Фільтри клієнтів (джерело, візити, дата)
- Автопривітання з ДН дитини
- RFM-аналітика
- Зв'язок сертифікатів із клієнтами
