...
let taskPermissionsLoaded = false;

function taskCapabilityDecision(capability, fallbackAllowed = false) {
    if (!taskPermissionsLoaded) {
        return {
            allowed: false,
            reasonCode: 'TASK_PERMISSIONS_LOADING'
        };
    }
...
function taskPermissionReasonLabel(reasonCode) {
    const labels = {
        ...
        TASK_PERMISSIONS_LOADING: '\u041f\u0440\u0430\u0432\u0430 \u0434\u043e\u0441\u0442\u0443\u043f\u0443 \u0449\u0435 \u0437\u0430\u0432\u0430\u043d\u0442\u0430\u0436\u0443\u044e\u0442\u044c\u0441\u044f.',
...
function applyPermissionsUI(perms) {
    ...
    if (templatesTab) {
        templatesTab.hidden = !canCreate;
        templatesTab.style.display = canCreate ? '' : 'none';
    }
    syncTaskSurfaceVisibility();
}
