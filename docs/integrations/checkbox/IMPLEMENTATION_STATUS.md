...
- Release package baseline prepared for this handoff: `0.81.206` (`Телефонія: Binotel workspace`).
- Release `0.81.206` is the package baseline prepared in this handoff.
