...
check('Booking pinata picker preserves operational 501-style numbers', bookingCode.includes('function bookingPinataNumberValue') && bookingCode.includes('function bookingPinataNumberDisplay') && bookingCode.includes('const operationalNumber = pinataNormalizeChoiceValue(design.pinata_number || design.number || design.code)') && bookingCode.includes("const number = operationalNumber || pinataNumberFromId('P', design.id || (index + 1))") && bookingCode.includes('pinata_number'));
