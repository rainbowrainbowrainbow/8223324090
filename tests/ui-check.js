...
checkPage('index.html', (doc, html) => {
    ...
    const recent058ChangelogOrder = ['v0.58.12','v0.58.11','v0.58.10','v0.58.9','v0.58.8','v0.58.7','v0.58.6','v0.58.5','v0.58.4','v0.58.3','v0.58.2','v0.58.1','v0.58.0'];
...
check('Sidebar identity card opens only useful clickable signal details', !sidebarCode.includes('function _fetchSidebarWeatherFallback') && sidebarCode.includes('function _showSidebarIdentityDetail') && sidebarCode.includes('data-sidebar-stop-profile="true"') && sidebarAuroraCss.includes('v0.58.0: enterprise sidebar navigation redesign') && sidebarAuroraCss.includes('.sidebar-identity-detail-panel') && sidebarAuroraCss.includes('.sidebar-identity-summary::before'));
...
check('Shared assistant rail links CRM windows with a magic transition bridge', assistantRailCode.includes('function initAssistantWindowBridge') && assistantRailCode.includes('new MutationObserver') && assistantRailCode.includes('function pulseAssistantWindowBridge') && assistantRailCode.includes('crm-assistant-magic-burst') && assistantRailCode.includes('crm-assistant-linked-window') && assistantRailCss.includes('v0.57.12: assistant window bridge') && assistantRailCss.includes('@keyframes assistantMagicDot') && assistantRailCss.includes('.crm-assistant-linked-window.crm-assistant-window-entering') && assistantRailCss.includes('prefers-reduced-motion: reduce'));
