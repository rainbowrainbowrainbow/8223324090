...
- Release package baseline prepared for this handoff: `0.81.113` (`Wallet: надійна обробка помилок`).
- Release `0.81.113` is the package baseline prepared in this handoff.
