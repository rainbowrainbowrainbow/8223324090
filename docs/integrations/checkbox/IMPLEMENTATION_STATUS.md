...
- Release package baseline prepared for this handoff: `0.81.108` (`Авторизація та нагороди без дублювання`).
- Release `0.81.108` is the package baseline prepared in this handoff.
