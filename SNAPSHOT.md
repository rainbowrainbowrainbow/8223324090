...
## Де ми
Версія **v5.36.0**. UI/UX overhaul серія v5.30–v5.38.
Зроблено v5.30–v5.36, залишилось v5.37–v5.38.
...
## Що далі
1. **v5.37** — Dark Mode & Typography Polish
2. **v5.38** — Image Asset Pack (favicon, PWA manifest)
...
---
*Оновлено: 2026-02-07, після v5.36*
