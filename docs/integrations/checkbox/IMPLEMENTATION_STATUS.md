...
- Release package baseline prepared for this handoff: `0.81.78` (`PARK/DAR Drain-aware Recovery`).
...
- Release `0.81.78` is the package baseline prepared in this handoff.
