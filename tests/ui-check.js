...
check('Shared assistant rail uses AI Command Bar instead of visible avatar presence', assistantRailCode.includes('assistant-command-form') && assistantRailCode.includes('assistant-command-mark') && assistantRailCode.includes('crmAssistantCommandPanel') && assistantRailCode.includes('placeholder="Запитати CRM або /команда"') && !assistantRailCode.includes('crmAssistantRailAvatar') && !assistantRailCode.includes('assistant-rail-avatar-core') && assistantRailCss.includes('v0.63.38: AI Command Bar') && assistantRailCss.includes('v0.63.40: hotfix AI Command Bar header geometry') && assistantRailCss.includes('.assistant-command-form') && assistantRailCss.includes('.assistant-command-panel') && assistantRailCss.includes('.crm-assistant-rail .assistant-rail-presence') && assistantRailCss.includes('display: none !important') && assistantRailCss.includes('grid-template-areas: "command mic stop voice replay expand"') && assistantRailCss.includes('display: contents !important') && assistantRailCss.includes('#crmAssistantMicBtn') && assistantRailCss.includes('#crmAssistantExpandBtn'));
