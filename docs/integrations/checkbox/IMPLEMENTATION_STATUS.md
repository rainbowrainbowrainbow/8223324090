...
- Release package baseline prepared for this handoff: `0.81.172` (`Dashboard: чистіша робоча композиція`).
- Release `0.81.172` is the package baseline prepared in this handoff.
