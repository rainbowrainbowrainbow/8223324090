...
- Release package baseline prepared for this handoff: `0.81.168` (`Новий Dashboard: орієнтир і віджети`).
- Release `0.81.168` is the package baseline prepared in this handoff.
