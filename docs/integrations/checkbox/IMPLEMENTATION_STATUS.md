...
- Release package baseline prepared for this handoff: `0.81.161` (`Авторизований вхід у гайдбук Design Board`).
- Release `0.81.161` is the package baseline prepared in this handoff.
