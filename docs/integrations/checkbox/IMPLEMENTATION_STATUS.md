...
- Live production package baseline prepared for this handoff: `0.80.120` (`Checkbox Shift Recovery`).
- Release commit prepared for this handoff: `24c18183731cb12903c7d13920889483a07335e8`.
...
- Release `0.80.120` is the package baseline prepared in this handoff. Reconfirm live version/commit before any future delivery or activation action.
