...
- Release package baseline prepared for this handoff: `0.82.7` (`Omni: чистий fallback без технічних ID`).
- Release `0.82.7` is the package baseline prepared in this handoff.
