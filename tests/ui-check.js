...
checkPage('staff.html', (doc, html) => {
    ...
    check('Staff schedule keeps premium HR Pulse switcher and unified panel rhythm',
        ...
        && html.includes('js/staff-schedule-shell.js?v=0.79.151')
        && html.includes('js/hr-pulse-switcher.js?v=0.79.151')
...
check('Sidebar timeline launcher shows mode counts instead of visible summary or checkmarks',
    ...
    && sidebarTimelineLauncherSmokeCode.includes("if (['GET', 'HEAD', 'OPTIONS'].includes(method))")
    && sidebarTimelineLauncherSmokeCode.includes('read-only launcher smoke attempted no non-read requests')
...
check('HR grouped IA keeps Pulse clean and vacancy workspace owns hiring surfaces',
    ...
    && htmlContains('hr.html', 'js/hr-pulse-switcher.js?v=0.79.151')
    ...
    && htmlContains('hr.html', 'js/staff-schedule-shell.js?v=0.79.151')
    && htmlContains('hr.html', 'js/staff-page.js?v=0.79.151')
