...
checkPage('staff.html', (doc, html) => {
    ...
    check('Staff schedule keeps premium HR Pulse switcher and unified panel rhythm',
        ...
        && html.includes('js/staff-schedule-shell.js?v=0.80.148')
        && html.includes('js/hr-pulse-switcher.js?v=0.80.148')
...
check('Profile completed-today pulse stays compact with inline metrics and micro-bars', profileCode.includes('let completedTodayDashboardExpanded = false') && profileCode.includes('function renderCabinetCompletedTodayDashboard') && profileCode.includes('cabinet-completed-today-pulse') && profileCode.includes('data-cabinet-completed-today-toggle') && profileCode.includes('data-cabinet-completed-today-all="true"') && !profileCode.includes('Історія на 36 записів тут не використовується') && !profileCode.includes('cabinetCompletedTodayExpanded') && profilePagesCss.includes('/* My Day completed-today premium pulse */') && profilePagesCss.includes('grid-template-columns: minmax(210px, 0.9fr) minmax(220px, 0.85fr) minmax(240px, 1fr) auto;') && profilePagesCss.includes('min-height: 34px;') && profilePagesCss.includes('grid-template-areas:') && profilePagesCss.includes('body.dark-mode .cabinet-completed-today-dashboard') && profilePagesCss.includes('html[data-theme="light"] body .cabinet-completed-today-dashboard') && profilePagesCss.includes('overflow: hidden;') && profilePagesCss.includes('height: 5px;'));
...
check('HR grouped IA keeps Pulse clean and vacancy workspace owns hiring surfaces',
    ...
    && htmlContains('hr.html', 'js/hr-pulse-switcher.js?v=0.80.148')
    ...
    && htmlContains('hr.html', 'js/staff-schedule-shell.js?v=0.80.148')
    && htmlContains('hr.html', 'js/staff-page.js?v=0.80.148')
...
check('HR Account Center uses the dedicated effective-access workspace',
    htmlContains('hr.html', 'css/account-access-editor.css?v=0.80.148')
    && htmlContains('hr.html', 'js/account-access-editor.js?v=0.80.148')
