...
| `/api/banquet-deposits` | `routes/banquet-deposits.js` | banquet deposit accountant workflow |
...
| `/api/my-day` | `routes/my-day.js` | personal My Day taxonomy, task classification, time tracking, and contribution matrix |
