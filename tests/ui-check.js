...
check('Room timeline activity blocks share marker card styling', timelineCode.includes('const isRoomTimelineActivityCard = isRoomTimelineView()') && timelineCode.includes("block.classList.add('is-room-timeline-activity-card')") && timelineConstructorCss.includes('body.timeline-view-rooms .booking-block.is-room-timeline-activity-card') && timelineConstructorCss.includes('body.timeline-view-rooms .timeline-room-service-marker') && timelineConstructorCss.includes('--timeline-room-card-accent') && timelineConstructorCss.includes('border-left: 4px solid var(--timeline-room-card-accent)') && timelineConstructorCss.includes('body.timeline-view-rooms .booking-block.is-room-timeline-activity-card.animation') && timelineConstructorCss.includes('body.timeline-view-rooms .booking-block.is-room-timeline-activity-card .booking-banquet-link-handle'));
