...
- Release package baseline prepared for this handoff: `0.81.105` (`Продукти: точні підсумки та навігація`).
- Release `0.81.105` is the package baseline prepared in this handoff.
