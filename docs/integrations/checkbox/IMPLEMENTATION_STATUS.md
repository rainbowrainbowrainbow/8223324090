...
- Release package baseline prepared for this handoff: `0.81.68` (`Checkbox Cashier UI Polish`).
- Confirmed live version and commit at the start of this release preparation: `0.81.67` at `f750fef72b306887c7b288d988f4ee03621ba7c7`.
...
- Release `0.81.68` is the package baseline prepared in this handoff.
- Release `0.81.67` is the confirmed live baseline before this `0.81.68` cashier UI polish is deployed.
