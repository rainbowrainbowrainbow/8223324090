...
- Release package baseline prepared for this handoff: `0.81.114` (`Wallet: стабільна історія монет`).
- Release `0.81.114` is the package baseline prepared in this handoff.
