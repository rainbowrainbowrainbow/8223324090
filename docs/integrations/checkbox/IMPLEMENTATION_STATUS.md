...
- Release package baseline prepared for this handoff: `0.81.188` (`WhatsApp webhook для Omni`).
- Release `0.81.188` is the package baseline prepared in this handoff.
