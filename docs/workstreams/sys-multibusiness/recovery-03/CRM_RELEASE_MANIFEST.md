...
- Live SHA from `/api/version` before this release: `0c7c72e24961f69449b1aa78cac08f558df68e55`
- Remote production branch base used for candidate: `94c9966c0018c36931627343311f64b777d52ddd`
- Candidate source branch: `codex/sys-mb-recover-03-20260913`
- Candidate HEAD before current production rebase: `231ecd1c18a6b4c92b692bcdc2d64c288de66839`
...
- Remote production branch drift absorbed: `94c9966c0018c36931627343311f64b777d52ddd` (`v0.81.164 — Dashboard без 500 у ризиках`) is preserved in the remediated candidate; live site still reported `0c7c72e24961f69449b1aa78cac08f558df68e55` before this SYS-MB deploy.
- Release version: `v0.81.165`
...
The candidate preserves production branch hotfixes through `94c9966c0018c36931627343311f64b777d52ddd` and adds SYS-MB commits on top.
...
- Version/cache/changelog marker `v0.81.165 — SYS-MB: перехід CRM`.
