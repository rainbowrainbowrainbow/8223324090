...
- Release package baseline prepared for this handoff: `0.81.77` (`Redirect Watchdog Old-Tab Recovery`).
...
- Release `0.81.77` is the package baseline prepared in this handoff.
