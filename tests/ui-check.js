...
check('Micro, short and tiny timeline activity blocks keep readable floors without artificial widths', timelineConstructorCss.includes('.booking-block.booking-block--micro,') && timelineConstructorCss.includes('.booking-block.booking-block--short,') && timelineConstructorCss.includes('.booking-block.booking-block--tiny') && timelineConstructorCss.includes('body.timeline-dashboard-page .booking-block.booking-block--tiny') && timelineConstructorCss.includes('padding: 5px 3px') && timelineConstructorCss.includes('body.timeline-dashboard-page .booking-block.booking-block--micro') && timelineConstructorCss.includes('padding: 0 !important') && timelineConstructorCss.includes('.booking-block.booking-block--micro .timeline-micro-booking-code') && timelineConstructorCss.includes('flex-direction: column') && timelineConstructorCss.includes('.booking-block.booking-block--short .timeline-compact-booking-label[data-code-length="7"]') && timelineConstructorCss.includes('.booking-block.booking-block--tiny .timeline-compact-booking-label[data-code-length="4"]') && timelineConstructorCss.includes('font-size: 7.5px') && timelineConstructorCss.includes('data-code-length="5"') && timelineConstructorCss.includes('font-size: 7px') && timelineConstructorCss.includes('data-code-length="6"') && !timelineConstructorCss.includes('font-size: 6px') && !timelineConstructorCss.includes('font-size: 5px') && !timelineConstructorCss.includes('font-size: 4px') && timelineConstructorCss.includes('body.timeline-view-rooms .booking-block.is-room-timeline-activity-card.booking-block--micro') && timelineConstructorCss.includes('.mini-booking-text[data-code-length="5"]') && !timelineConstructorCss.includes('min-width: 124px'));
