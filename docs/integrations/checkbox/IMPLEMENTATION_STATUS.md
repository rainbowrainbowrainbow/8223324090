...
- Release package baseline prepared for this handoff: `0.81.171` (`Dashboard: чистіший перший екран`).
- Release `0.81.171` is the package baseline prepared in this handoff.
