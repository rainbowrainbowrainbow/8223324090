...
- **Перенос є реальним reschedule, а не DOM-перестановкою** - дія викликає `/api/tasks/:id/reschedule`, ставить deadline на поточний київський день і після успіху оновлює обидві проекції.
