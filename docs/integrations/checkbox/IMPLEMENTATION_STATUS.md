...
- Release package baseline prepared for this handoff: `0.81.104` (`Оптимізація повторюваних бронювань і звуку`).
- Release `0.81.104` is the package baseline prepared in this handoff.
