...
- Release package baseline prepared for this handoff: `0.81.123` (`Omni: докази релізу WhatsApp`).
- Release `0.81.123` is the package baseline prepared in this handoff.
