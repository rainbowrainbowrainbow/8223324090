...
- Release package baseline prepared for this handoff: `0.82.1` (`Omni: зв’язки лідів і діалогів`).
- Release `0.82.1` is the package baseline prepared in this handoff.
