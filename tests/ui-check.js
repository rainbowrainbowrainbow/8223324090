...
checkPage('staff.html', (doc, html) => {
    ...
    check('Staff schedule keeps premium HR Pulse switcher and unified panel rhythm',
        ...
        && html.includes('js/staff-schedule-shell.js?v=0.78.85')
        && html.includes('js/hr-pulse-switcher.js?v=0.78.85')
...
check('HR grouped IA keeps Pulse clean and vacancy workspace owns hiring surfaces',
    ...
    && htmlContains('hr.html', 'js/hr-pulse-switcher.js?v=0.78.85')
    ...
    && htmlContains('hr.html', 'js/staff-schedule-shell.js?v=0.78.85')
    && htmlContains('hr.html', 'js/staff-page.js?v=0.78.85')
