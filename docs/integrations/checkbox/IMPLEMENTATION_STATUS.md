...
- Release package baseline prepared for this handoff: `0.81.132` (`Omni: докази релізу техборгу`).
- Release `0.81.132` is the package baseline prepared in this handoff.
