...
- Release package baseline prepared for this handoff: `0.81.189` (`Omni: фінальна адаптивна робоча область`).
- Release `0.81.189` is the package baseline prepared in this handoff.
