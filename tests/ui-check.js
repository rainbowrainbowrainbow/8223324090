...
checkPage('booking-summary.html', (doc, html) => {
    ...
    check('Booking summary hero header uses image background, real logo, and glass booking card',
        ...
        && banquetHeroRule.includes('grid-template-columns: 64px minmax(0, 1fr) minmax(190px, 0.44fr)')
        && banquetHeroRule.includes('min-height: 182px')
        && banquetHeroRule.includes('padding: 22px 26px')
        ...
        && bookingCardRule.includes('backdrop-filter: blur(12px)')
        ...
        && printCss.includes('grid-template-columns: 46px minmax(0, 1fr) minmax(132px, 0.42fr)')
        && printCss.includes('min-height: 38mm')
