...
check('Sidebar compact density reduces menu footprint without changing shell ownership', sidebarAuroraCss.includes('v0.55.30: compact sidebar density') && sidebarAuroraCss.includes('--eg-claude-sidebar-w: clamp(260px, 15.5vw, 320px)') && sidebarAuroraCss.includes('.sidebar-nav:not(.collapsed) .sidebar-alert-hero') && sidebarAuroraCss.includes('min-height: 42px !important') && sidebarAuroraCss.includes('.sidebar-nav:not(.collapsed) .sidebar-design-extra-link') && sidebarAuroraCss.includes('.sidebar-nav:not(.collapsed) .sidebar-links .nav-link'));
