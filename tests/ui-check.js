...
check('Sidebar additional menu supports user-managed custom pages without external defaults', sidebarCode.includes('EXTRA_MENU_STORAGE_KEY') && sidebarCode.includes('_readCustomExtraItems') && sidebarCode.includes('_bindExtraMenuEditor') && sidebarCode.includes('data-sidebar-extra-form') && sidebarCode.includes('data-sidebar-extra-edit') && sidebarCode.includes('data-sidebar-extra-delete') && !sidebarCode.includes('Notion · daily ops') && !sidebarCode.includes('calendar.google.com') && !sidebarCode.includes('web.monobank.ua'));
...
check('Sidebar compact density reduces menu footprint without changing shell ownership', sidebarAuroraCss.includes('v0.55.30: compact sidebar density') && sidebarAuroraCss.includes('--eg-claude-sidebar-w: clamp(260px, 15.5vw, 320px)') && sidebarAuroraCss.includes('.sidebar-nav:not(.collapsed) .sidebar-alert-hero') && sidebarAuroraCss.includes('min-height: 56px !important') && sidebarAuroraCss.includes('.sidebar-nav:not(.collapsed) .sidebar-design-extra-link') && sidebarAuroraCss.includes('.sidebar-nav:not(.collapsed) .sidebar-links .nav-link'));
...
check('Sidebar day and extras sections have stable ordered rerender slots', sidebarCode.includes('EXTRA_MENU_COLLAPSED_STORAGE_KEY') && sidebarCode.includes('function _syncSidebarSectionOrder') && sidebarCode.includes('data-sidebar-extra-toggle-section') && sidebarAuroraCss.includes('v0.55.32: stable sidebar section order') && sidebarAuroraCss.includes('.sidebar-command-deck') && sidebarAuroraCss.includes('order: 10 !important') && sidebarAuroraCss.includes('.sidebar-today-dock') && sidebarAuroraCss.includes('order: 20 !important') && sidebarAuroraCss.includes('.sidebar-design-extras') && sidebarAuroraCss.includes('order: 30 !important') && sidebarAuroraCss.includes('.sidebar-links') && sidebarAuroraCss.includes('order: 40 !important'));
...
check('Sidebar additional editor has bounded form controls', sidebarAuroraCss.includes('configurable Additional pages editor') && sidebarAuroraCss.includes('.sidebar-extra-editor') && sidebarAuroraCss.includes('.sidebar-extra-input') && sidebarAuroraCss.includes('.sidebar-design-extra-actions'));
