...
- Release package baseline prepared for this handoff: `0.82.4` (`Omni: імена Facebook та Instagram`).
- Release `0.82.4` is the package baseline prepared in this handoff.
