...
- Release package baseline prepared for this handoff: `0.81.115` (`HR чеклісти: стабільні перевірки`).
- Release `0.81.115` is the package baseline prepared in this handoff.
