...
- Release package baseline prepared for this handoff: `0.82.5` (`Omni: коректні імена та Instagram-теги`).
- Release `0.82.5` is the package baseline prepared in this handoff.
