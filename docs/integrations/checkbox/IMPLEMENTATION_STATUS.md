...
- Release package baseline prepared for this handoff: `0.81.147` (`Omni: Viber Bridge paired-only release`).
- Release `0.81.147` is the package baseline prepared in this handoff.
