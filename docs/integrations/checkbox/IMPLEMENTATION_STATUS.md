...
- Release package baseline prepared for this handoff: `0.81.194` (`Omni: чернетка і позиція історії`).
- Release `0.81.194` is the package baseline prepared in this handoff.
