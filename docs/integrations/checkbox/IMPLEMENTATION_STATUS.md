...
- Release package baseline prepared for this handoff: `0.82.15` (`Сертифікати: одноразове погашення`).
- Release `0.82.15` is the package baseline prepared in this handoff.
