...
checkPage('staff.html', (doc, html) => {
    ...
    check('Staff schedule keeps premium HR Pulse switcher and unified panel rhythm',
        ...
        && html.includes('js/staff-schedule-shell.js?v=0.81.180')
        && html.includes('js/hr-pulse-switcher.js?v=0.81.180')
...
check('Dashboard offers accessible widget handles and responsive drop feedback', dashboardPageCode.includes('class="widget-drag-handle"') && dashboardPageCode.includes('aria-label="Перемістити:') && dashboardCss.includes('.dashboard-grid.dashboard-widget-grid') && dashboardCss.includes('repeat(3, minmax(0, 1fr))') && dashboardCss.includes('repeat(2, minmax(0, 1fr))') && dashboardCss.includes('grid-template-columns: minmax(0, 1fr)') && dashboardCss.includes('touch-action: none') && dashboardCss.includes('min-height: 44px') && dashboardCss.includes('.widget-card.is-dragging') && dashboardCss.includes('.widget-card.is-drop-target'));
check('Dashboard explains widget movement in Ukrainian and announces layout saves', dashboardHtml.includes('<h1>Сьогодні</h1>') && dashboardHtml.includes('Перетягуйте віджети за ⠿') && dashboardHtml.includes('id="dashboardLayoutStatus" role="status" aria-live="polite"') && !dashboardHtml.includes('dashboard-workspace-stage') && !dashboardHtml.includes('board-tool-rail') && !dashboardHtml.includes('data-board-tool-family='));
...
check('HR grouped IA keeps Pulse clean and vacancy workspace owns hiring surfaces',
    ...
    && htmlContains('hr.html', 'js/hr-pulse-switcher.js?v=0.81.180')
    ...
    && htmlContains('hr.html', 'js/staff-schedule-shell.js?v=0.81.180')
    && htmlContains('hr.html', 'js/staff-schedule-loader.js?v=0.81.180')
    && !htmlContains('hr.html', 'js/staff-page.js?v=0.81.180')
...
check('HR Account Center uses the dedicated effective-access workspace',
    htmlContains('hr.html', 'css/account-access-editor.css?v=0.81.180')
    && htmlContains('hr.html', 'js/account-access-editor.js?v=0.81.180')
