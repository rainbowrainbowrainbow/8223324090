...
- Release package baseline prepared for this handoff: `0.81.17` (`Checkbox Test Receipt Contract`).
...
- Release `0.81.17` is the package baseline prepared in this handoff.
