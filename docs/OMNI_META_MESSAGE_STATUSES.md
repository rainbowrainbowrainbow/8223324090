...
Production impact: yes — після деплою. Цей блок підготовлено локально, без релізу.
...
Скріншоти перевірено візуально. CI у цьому блоці не запускався.
...
Деплою не було, live QA не виконано.
