...
- Release package baseline prepared for this handoff: `0.80.147` (`Trusted QA Standalone Cleanup`).
...
- Release `0.80.147` is the package baseline prepared in this handoff. Reconfirm live version/commit before any future delivery or activation action.
