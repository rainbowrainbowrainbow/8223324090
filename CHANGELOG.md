...
## v0.66.63 - CRM 66.63: дефолтний бізнес акаунта

### CRM / акаунти / бізнес-перемикач / 27.05.2026 [codex]
...
- **Regression guard** - оновлено auth/account lifecycle та business-context тести, щоб login, verify, refresh, impersonation і role update повертали та зберігали дефолтний бізнес.
