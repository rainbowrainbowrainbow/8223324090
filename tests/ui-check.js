...
check('Profile avatar crop stays synced across profile, sidebar and refresh verify', profileCode.includes('PROFILE_AVATAR_CROP_DEFAULT') && profileCode.includes('profileAvatarCropStorageKey') && profileCode.includes('profileAvatarZoom') && profileCode.includes('saveProfileAvatarCrop') && profileCode.includes('applyProfileAvatarCropToImage') && profilePagesCss.includes('.profile-avatar-crop-card') && profileSidebarCode.includes('_readSidebarAvatarCrop') && profileSidebarCode.includes('_applySidebarAvatarCrop') && profileApiCode.includes('function mergeApiCurrentUser') && profileApiCode.includes('return mergeApiCurrentUser(data.user);'));
