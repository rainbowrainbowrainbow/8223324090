...
const TIMELINE_DEFAULT_ZOOM_MINUTES = 15;
...
function mapApiProductToTimelineProduct(p) {
    return {
        ...
        name: p.name,
        icon: p.icon,
        iconUrl: p.iconUrl || p.icon_url || null,
        imageUrl: p.imageUrl || p.image_url || p.photoUrl || p.photo_url || p.coverUrl || p.cover_url || p.thumbnailUrl || p.thumbnail_url || p.iconUrl || p.icon_url || null,
        ...
        promoDescription: p.promoDescription || p.promo_description || null,
        promoUrl: p.promoUrl || p.promo_url || p.marketingUrl || p.marketing_url || null,
        catalogId: p.catalogId || p.catalog_id || null,
        catalogUrl: p.catalogUrl || p.catalog_url || p.catalogHref || p.catalog_href || null,
