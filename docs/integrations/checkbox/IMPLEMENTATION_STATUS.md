...
- Release package baseline prepared for this handoff: `0.81.180` (`Клієнти: компактний список без скролу`).
- Release `0.81.180` is the package baseline prepared in this handoff.
