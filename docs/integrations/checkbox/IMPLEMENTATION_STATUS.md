...
- Release package baseline prepared for this handoff: `0.81.138` (`Omni: чесні можливості Viber Bridge`).
- Release `0.81.138` is the package baseline prepared in this handoff.
