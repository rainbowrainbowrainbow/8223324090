const INTEGRATION_AUTH_CONTRACTS = Object.freeze({
    telegramWebhook: { guardFiles: [{ file: 'routes/telegram.js', needles: ["router.post('/webhook'", 'secretHeader !== WEBHOOK_SECRET'] }], testFiles: ['tests/auth-boundary.test.js', 'tests/route-smoke.test.js'] },
    omniWebhooks: { guardFiles: [{ file: 'routes/omnichannel.js', needles: ['verifyViberSignature', 'verifyWebhookSecret', 'verifyMetaSignature'] }], testFiles: ['tests/auth-boundary.test.js', 'tests/omni-provider-lifecycle.test.js'] },
    reportBotWebhook: { guardFiles: [{ file: 'routes/report-bot.js', needles: ["router.post('/webhook'", 'secretHeader !== expectedSecret'] }], testFiles: ['tests/auth-boundary.test.js', 'tests/route-smoke.test.js'] },
    reportBotApi: { guardFiles: [{ file: 'routes/report-bot.js', needles: ['async function requireBotApiKey', "router.post('/submit', requireBotApiKey"] }], testFiles: ['tests/auth-boundary.test.js', 'tests/route-smoke.test.js'] },
    hermesApi: { guardFiles: [{ file: 'middleware/hermesAuth.js', needles: ['function createHermesAuthMiddleware', 'timingSafeSecretEqual'] }, { file: 'routes/hermes.js', needles: ['router.use(authMiddleware)'] }], testFiles: ['tests/hermes-auth.test.js', 'tests/auth-boundary.test.js'] },
    personalAccountsBot: { guardFiles: [{ file: 'routes/personal-accounts.js', needles: ['function isBotAuth', 'function optionalJwt', 'function verifyAccess'] }], testFiles: ['tests/personal-accounts-jwt-telegram.test.js', 'tests/route-smoke.test.js'] },
    kleshnyaBridge: { guardFiles: [{ file: 'routes/kleshnya.js', needles: ['KLESHNYA_WEBHOOK_SECRET', "router.get('/pending-messages'", "router.post('/sync-chat'", "router.post('/webhook'"] }], testFiles: ['tests/kleshnya.test.js', 'tests/route-smoke.test.js'] },
    kieCallback: { guardFiles: [{ file: 'routes/music.js', needles: ["router.post('/library/generate-music/callback'", 'KIE_CALLBACK_SECRET'] }], testFiles: ['tests/auth-boundary.test.js', 'tests/route-smoke.test.js'] },
    universalLeadWebhook: { guardFiles: [{ file: 'routes/leads.js', needles: ['async function handleUniversalWebhook', 'timingSafeTextEqual(token, UNIVERSAL_WEBHOOK_TOKEN)'] }], testFiles: ['tests/auth-boundary.test.js', 'tests/route-smoke.test.js'] },
    maysternyaBookingWebhook: { guardFiles: [{ file: 'routes/leads.js', needles: ['async function handleMaysternyaBookingWebhook', 'timingSafeTextEqual(token, UNIVERSAL_WEBHOOK_TOKEN)'] }], testFiles: ['tests/auth-boundary.test.js', 'tests/route-smoke.test.js'] },
    maysternyaAvailabilityWebhook: { guardFiles: [{ file: 'routes/leads.js', needles: ['async function handleMaysternyaAvailabilityWebhook', 'timingSafeTextEqual(token, UNIVERSAL_WEBHOOK_TOKEN)'] }], testFiles: ['tests/auth-boundary.test.js', 'tests/route-smoke.test.js'] }
});
