...
## v0.55.26 - Навігація: редактор додаткових сторінок

### Sidebar / Custom Extra Pages [codex]
- **Редактор Додатково** - у блоці `+ Додатково` додано режим редагування без зміни коду.
- **Кастомні сторінки** - можна додати внутрішню сторінку CRM або зовнішній URL з назвою, описом і іконкою.
- **Редагування** - користувацькі пункти можна перейменувати, змінити шлях/URL/опис/іконку або видалити.
- **Guardrail** - додано UI-smoke перевірки для configurable extra pages contract і bounded form controls.
