...
check('Profile cabinet tasker has truthful segment counts and composer', profileCode.includes('const CABINET_TASK_SEGMENTS') && profileCode.includes('function cabinetTaskMatchesSegment') && profileCode.includes('function cabinetSegmentCounts') && profileCode.includes('function renderCabinetTaskComposer') && profileCode.includes('data-cabinet-active-segment') && profileCode.includes('data-cabinet-due-preset') && profilePagesCss.includes('.cabinet-task-composer') && profilePagesCss.includes('.cabinet-list-head') && profilePagesCss.includes('.cabinet-task-priority'));
