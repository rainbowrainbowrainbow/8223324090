...
check('Design file downloads use authenticated Blob transport and iPhone-safe helpers', designsPageCode.includes('fetchDesignBlob') && designsPageCode.includes('authHeaders(false)') && designsPageCode.includes('finishBlobDownload') && designsPageCode.includes('openTouchDownloadWindow') && !designsPageCode.includes('openSafeNewTab(href)'));
