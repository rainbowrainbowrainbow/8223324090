...
- Release package baseline prepared for this handoff: `0.81.153` (`Рішення щодо legacy-матеріалів Design Board`).
- Release `0.81.153` is the package baseline prepared in this handoff.
