...
- Release package baseline prepared for this handoff: `0.81.47` (`Timeline Presentation System v2`).
...
- Release `0.81.47` is the package baseline prepared in this handoff.
