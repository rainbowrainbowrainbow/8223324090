...
- Release package baseline prepared for this handoff: `0.81.106` (`Оптимізація стартових запитів dashboard`).
- Release `0.81.106` is the package baseline prepared in this handoff.
