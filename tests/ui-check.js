...
checkPage('staff.html', (doc, html) => {
    ...
    check('Staff schedule keeps premium HR Pulse switcher and unified panel rhythm',
        ...
        && html.includes('js/staff-schedule-shell.js?v=0.81.56')
        && html.includes('js/hr-pulse-switcher.js?v=0.81.56')
...
check('Micro, short and tiny timeline activity blocks keep readable floors without artificial widths',
    ...
    && timelineConstructorCss.includes('.booking-block.booking-block--short .timeline-compact-booking-label[data-code-length="5"]')
    && timelineConstructorCss.includes('.booking-block.booking-block--short .timeline-compact-booking-label[data-code-length="6"]')
    && timelineConstructorCss.includes('.booking-block.booking-block--short .timeline-compact-booking-label[data-code-length="7"]')
    && timelineConstructorCss.includes('.booking-block.booking-block--short .timeline-compact-booking-label[data-code-length="8"]')
    ...
    && timelineConstructorCss.includes('.booking-block.booking-block--tiny .timeline-compact-booking-label[data-code-length="4"]')
    && timelineConstructorCss.includes('.booking-block.booking-block--tiny .timeline-compact-booking-label[data-code-length="7"]')
    && timelineConstructorCss.includes('.booking-block.booking-block--tiny .timeline-compact-booking-label[data-code-length="8"]')
    ...
    && timelineConstructorCss.includes('font-size: 8.5px')
    && timelineConstructorCss.includes('font-size: 7.5px')
    && timelineConstructorCss.includes('font-size: 7px')
    && timelineConstructorCss.includes('data-code-length="5"')
    && timelineConstructorCss.includes('data-code-length="6"')
    ...
    && timelineConstructorCss.includes('.mini-booking-text[data-code-length="5"]')
...
check('HR grouped IA keeps Pulse clean and vacancy workspace owns hiring surfaces',
    ...
    && htmlContains('hr.html', 'js/hr-pulse-switcher.js?v=0.81.56')
    ...
    && htmlContains('hr.html', 'js/staff-schedule-shell.js?v=0.81.56')
    && htmlContains('hr.html', 'js/staff-page.js?v=0.81.56')
...
check('HR Account Center uses the dedicated effective-access workspace',
    htmlContains('hr.html', 'css/account-access-editor.css?v=0.81.56')
    && htmlContains('hr.html', 'js/account-access-editor.js?v=0.81.56')
