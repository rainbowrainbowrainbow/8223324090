...
- Release package baseline prepared for this handoff: `0.81.28` (`Profile avatar upload fallback 404`).
...
- Release `0.81.28` is the package baseline prepared in this handoff.
