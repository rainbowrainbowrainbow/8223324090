...
test('products frontend wires document linkage and catalog entry points', () => {
    ...
    assert.match(pageJs, /function createKitchenMenuExternalDraft/);
    assert.match(pageJs, /function readMenuImageFileAsDataUrl/);
    ...
    assert.match(pageJs, /data-menu-image-action="external-draft"/);
    assert.match(pageJs, /data-menu-image-file/);
    assert.match(pageJs, /data-menu-image-url/);
    ...
    assert.match(pageJs, /apiCreateProductMenuExternalDraft/);
...
test('products API reuses existing catalog engine and validates source documents', () => {
    ...
    assert.match(timelineCodeMigration, /FOR collision IN[\s\S]*suffix_counter := 2[\s\S]*EXIT WHEN NOT EXISTS/);
    ...
    assert.match(productsRoute, /createExternalMenuImageDraft/);
    assert.match(productsRoute, /persistMenuImageDraft/);
    ...
    assert.match(menuImageDraftService, /function buildMenuImageContext/);
    assert.match(menuImageDraftService, /function assertExternalDraftPayloadFields/);
    ...
    assert.match(menuImageDraftService, /function createExternalMenuImageDraft/);
    assert.match(menuImageDraftService, /function persistMenuImageDraft/);
    assert.match(menuImageDraftService, /menu_image_upload_failed/);
    assert.match(menuImageDraftService, /targetUsage:\s*DEFAULT_TARGET_USAGE/);
    assert.match(menuImageDraftService, /currentImageUrl/);
    assert.match(menuImageDraftService, /draftImageUrl/);
