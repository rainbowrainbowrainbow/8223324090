...
- Release `0.81.16` is the package baseline prepared in this handoff. It is also the confirmed live baseline before this hardening patch; reconfirm live version/commit before future delivery or activation.
