...
checkPage('staff.html', (doc, html) => {
    ...
    check('Staff schedule keeps premium HR Pulse switcher and unified panel rhythm',
        ...
        && html.includes('js/staff-schedule-shell.js?v=0.81.38')
        && html.includes('js/hr-pulse-switcher.js?v=0.81.38')
...
check('Micro, short and tiny timeline activity blocks fit 2-6 character codes without artificial widths', timelineConstructorCss.includes('.booking-block.booking-block--micro,') && timelineConstructorCss.includes('.booking-block.booking-block--short,') && timelineConstructorCss.includes('.booking-block.booking-block--tiny') && timelineConstructorCss.includes('body.timeline-dashboard-page .booking-block.booking-block--tiny') && timelineConstructorCss.includes('padding: 5px 3px') && timelineConstructorCss.includes('.booking-block.booking-block--micro .timeline-micro-booking-code') && timelineConstructorCss.includes('data-code-length="5"') && timelineConstructorCss.includes('font-size: 6px') && timelineConstructorCss.includes('body.timeline-view-rooms .booking-block.is-room-timeline-activity-card.booking-block--micro') && timelineConstructorCss.includes('.mini-booking-text[data-code-length="5"]') && !timelineConstructorCss.includes('min-width: 124px'));
...
check('HR grouped IA keeps Pulse clean and vacancy workspace owns hiring surfaces',
    ...
    && htmlContains('hr.html', 'js/hr-pulse-switcher.js?v=0.81.38')
    ...
    && htmlContains('hr.html', 'js/staff-schedule-shell.js?v=0.81.38')
    && htmlContains('hr.html', 'js/staff-page.js?v=0.81.38')
...
check('HR Account Center uses the dedicated effective-access workspace',
    htmlContains('hr.html', 'css/account-access-editor.css?v=0.81.38')
    && htmlContains('hr.html', 'js/account-access-editor.js?v=0.81.38')
