...
- Release package baseline prepared for this handoff: `0.81.118` (`Випускні: ізоляція бізнесів`).
- Release `0.81.118` is the package baseline prepared in this handoff.
