...
- Release package baseline prepared for this handoff: `0.81.173` (`Dashboard: фокус без зайвої дії`).
- Release `0.81.173` is the package baseline prepared in this handoff.
