...
check('Room timeline service markers remain isolated from animator timeline',
    ...
    && timelineResourcesTestCode.includes('room timeline de-emphasizes duplicate kitchen booking block when service markers exist')
...
check('Animator timeline booking blocks show room meta without room timeline duplication', timelineCode.includes('const bookingRoomName = String(renderBooking.room || \'\').trim()') && timelineCode.includes('&& isParkAnimatorTimelineView()') && timelineCode.includes("(!isRoomTimelineView() && !shouldShowBookingRoomMeta ? bookingRoomName : '')") && timelineCode.includes('class="booking-block-room"') && timelineConstructorCss.includes('.booking-block .booking-block-room') && timelineConstructorCss.includes('.booking-block.has-booking-room-meta .subtitle') && timelineConstructorCss.includes('gap: 6px') && timelineConstructorCss.includes('.booking-block.has-booking-room-meta .booking-block-room') && timelineConstructorCss.includes('margin-left: 0') && timelineConstructorCss.includes('max-width: min(96px, calc(100% - 48px))') && timelineConstructorCss.includes('body.dark-mode .booking-block .booking-block-room') && timelineConstructorCss.includes('html[data-theme="dark"] .booking-block .booking-block-room'));
...
check('Room timeline operational lanes separate markers and activity cards', timelineCode.includes('function syncTimelineRoomOperationalLayout(lineGrid = null)') && timelineCode.includes("lineGrid.querySelectorAll('.timeline-room-service-marker')") && timelineCode.includes(".booking-block.is-room-timeline-activity-card:not(.status-hidden)") && timelineCode.includes('dataset.roomOperationalLane = String(lane)') && timelineCode.includes("style.setProperty('--timeline-room-lane-top'") && timelineCode.includes('dataset.roomActivityLane = String(lane)') && timelineCode.includes('syncTimelineRoomOperationalLayout(lineGrid);') && timelineConstructorCss.includes('.line-grid.has-timeline-room-operational-lanes') && timelineConstructorCss.includes('.timeline-line.has-timeline-room-operational-lanes') && timelineConstructorCss.includes('body.timeline-view-rooms .timeline-container.compact .timeline-line.has-timeline-room-operational-lanes') && timelineConstructorCss.includes('body.timeline-view-rooms .timeline-container.compact .timeline-line.has-timeline-room-service-marker-lanes > .line-grid') && timelineConstructorCss.includes('--timeline-room-operational-row-height') && timelineConstructorCss.includes('--timeline-room-activity-card-height: 72px') && timelineConstructorCss.includes('height: var(--timeline-room-activity-card-height)'));
...
check('Short and tiny timeline activity blocks have dedicated compact CSS layout', timelineConstructorCss.includes('.booking-block.booking-block--short,') && timelineConstructorCss.includes('.booking-block.booking-block--tiny') && timelineConstructorCss.includes('flex-direction: column') && timelineConstructorCss.includes('max-width: calc(100% - 18px)') && timelineConstructorCss.includes('.booking-block.booking-block--tiny .timeline-compact-booking-meta') && timelineConstructorCss.includes('.booking-block.booking-block--tiny .duration-badge') && timelineConstructorCss.includes('display: none') && timelineConstructorCss.includes('.booking-block.booking-block--short .booking-block-room') && timelineConstructorCss.includes('body.timeline-view-rooms .booking-block.is-room-timeline-activity-card.booking-block--short') && timelineConstructorCss.includes('min-width: 124px') && timelineConstructorCss.includes('white-space: normal') && timelineConstructorCss.includes('-webkit-line-clamp: 2') && timelineConstructorCss.includes('body.dark-mode .booking-block.booking-block--short .timeline-compact-booking-label') && timelineConstructorCss.includes('body.timeline-view-rooms .booking-block.is-room-timeline-activity-card.pinata') && timelineConstructorCss.includes('--timeline-room-card-accent: #F472B6') && timelineConstructorCss.includes('--timeline-room-card-accent: #84CC16') && timelineConstructorCss.includes('--timeline-room-card-accent: #22D3EE') && timelineConstructorCss.includes('--timeline-room-card-accent: #A78BFA'));
