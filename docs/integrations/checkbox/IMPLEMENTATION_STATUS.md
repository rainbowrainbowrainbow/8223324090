...
- Release package baseline prepared for this handoff: `0.81.179` (`Клієнти: читабельний список`).
- Release `0.81.179` is the package baseline prepared in this handoff.
