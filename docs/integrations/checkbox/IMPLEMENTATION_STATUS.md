...
- Release package baseline prepared for this handoff: `0.81.205` (`Телефонія: Binotel workspace`).
- Release `0.81.205` is the package baseline prepared in this handoff.
