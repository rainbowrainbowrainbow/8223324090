...
- Release package baseline prepared for this handoff: `0.81.107` (`Профілі зарплати у ЗП та KPI`).
- Release `0.81.107` is the package baseline prepared in this handoff.
