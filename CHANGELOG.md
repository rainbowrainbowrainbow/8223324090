...
## 2026-02-12 — v7.9.1 SVG іконки програм

**Іконки:**
- Замість емодзі — 7 красивих SVG іконок для категорій програм
- Квести (карта з лупою), Анімація (колпак з конфеті), Шоу (чарівна паличка)
- Фото (камера), Майстер-класи (палітра), Піньяти (зірка з цукерками), Інше (олівець)
- Векторна графіка, адаптивні розміри на всіх брейкпоінтах
- Підтримка в панелі бронювання і на сторінці Програми
