...
- **Font**: Nunito (Google Fonts) — this is the project font, keep it
- **Design System v4.0** in `css/base.css` — emerald primary (#10B981), warm accents
- **11-file modular CSS** architecture
- **Dark mode** support required (body.dark-mode + [data-theme="dark"])
- **Touch targets** min 44px (WCAG 2.1)
- **UI language**: Ukrainian

When working on this project, respect existing design tokens but push for bold, memorable visual choices within that framework.
