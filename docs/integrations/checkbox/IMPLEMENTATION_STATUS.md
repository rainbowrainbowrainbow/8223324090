...
- Release package baseline prepared for this handoff: `0.82.3` (`Omni: підтверджений прийом WhatsApp`).
- Release `0.82.3` is the package baseline prepared in this handoff.
