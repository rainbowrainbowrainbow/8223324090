...
- Release package baseline prepared for this handoff: `0.81.202` (`Omni: фірмові іконки каналів`).
- Release `0.81.202` is the package baseline prepared in this handoff.
