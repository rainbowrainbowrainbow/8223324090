...
| `certificates.html` | `/certificates` | certificates | canonical-page | Also serves `/certificates/new`, `/certificates/batch`, and authenticated mobile `/certificates/check` flows. |
