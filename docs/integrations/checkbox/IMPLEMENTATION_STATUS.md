...
- Release package baseline prepared for this handoff: `0.81.71` (`Auth Navigation Session Hardening`).
...
- Release `0.81.71` is the package baseline prepared in this handoff.
