...
- Release package baseline prepared for this handoff: `0.82.10` (`SYS-MB: каталог і timeline після cutover`).
- Release `0.82.10` is the package baseline prepared in this handoff.
