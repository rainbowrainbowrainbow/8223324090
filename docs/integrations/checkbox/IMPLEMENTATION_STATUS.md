...
- Release package baseline prepared for this handoff: `0.81.175` (`HR і події: чесні стани та надійна черга`).
- Release `0.81.175` is the package baseline prepared in this handoff.
