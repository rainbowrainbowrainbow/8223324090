...
- Release package baseline prepared for this handoff: `0.81.111` (`HR чеклісти та сумісність Wallet`).
- Release `0.81.111` is the package baseline prepared in this handoff.
