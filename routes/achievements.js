    ...
    try {
        ...
        for (const ach of uncompleted.rows) {
            ...
            if (progress > 0 || achieved) {
                ...
                `, [userId, ach.id, progress, achieved, achieved ? new Date() : null]);
