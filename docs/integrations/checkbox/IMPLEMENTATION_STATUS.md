...
- Release package baseline prepared for this handoff: `0.82.20` (`HR Парку: картка зі Сьогодні`).
- Release `0.82.20` is the package baseline prepared in this handoff.
