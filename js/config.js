...
const PROGRAMS = [
    ...
    { id: 'photo_magnet_extra', code: 'Магн', label: 'Магн', name: 'Додатковий магніт', icon: '🧲', category: 'photo', duration: 0, price: 100, hosts: 0, perChild: true, description: 'Коли дітей більше п\'яти — замовляйте додаткові магніти, щоб кожен гість отримав свій сувенір. Ціна за 1 магніт.' },
