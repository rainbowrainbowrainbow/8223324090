...
Production impact: yes. Власник дозволив завершити запропонований блок OMNI-INBOX-RELEASE повідомленням «ДОРОБЛЮЙ!». Документ фіксує план і preflight; сам по собі не є доказом deploy.

Повторний preflight: remote production просунувся до `8cc2fa19ff931009cadbe15dbf0fc8448fd45173` (v0.81.90), його CI успішний. Пакет Omni перенесено поверх цієї бази через rebase без конфліктів; зміни каси збережено. Реліз Omni: `0.81.91`, `Omni Human Inbox`.
