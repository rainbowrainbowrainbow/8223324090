...
const PROGRAMS = [
    ...
    { id: 'pinata_own', code: 'ПінВ', label: 'ПінВ(15)', name: 'Власна піньята', icon: '🪅🏠', category: 'pinata', duration: 15, price: 0, hosts: 1, hasFiller: false, age: '2-99р', kids: 'до 15', description: 'Клієнт приносить свою піньяту; ми тільки проводимо церемонію розбивання.' },
