...
checkPage('staff.html', (doc, html) => {
    ...
    check('Staff schedule keeps premium HR Pulse switcher and unified panel rhythm',
        ...
        && html.includes('js/staff-schedule-shell.js?v=0.78.81')
        && html.includes('js/hr-pulse-switcher.js?v=0.78.81')
    ...
    check('Staff schedule exposes a validated custom period picker',
        ...
        && staffScheduleShellCode.includes('>1 половина</button>')
        && staffScheduleShellCode.includes('>2 половина</button>')
        && staffScheduleShellCode.includes('>Весь місяць</button>')
        && staffScheduleShellCode.includes('aria-label="Показати другу половину місяця"')
        ...
        && staffCode.includes('const STAFF_SCHEDULE_LONG_RANGE_DAYS = 15')
...
check('HR grouped IA keeps Pulse clean and vacancy workspace owns hiring surfaces',
    ...
    && htmlContains('hr.html', 'js/hr-pulse-switcher.js?v=0.78.81')
    ...
    && htmlContains('hr.html', 'js/staff-schedule-shell.js?v=0.78.81')
    && htmlContains('hr.html', 'js/staff-page.js?v=0.78.81')
