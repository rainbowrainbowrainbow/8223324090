...
- Release package baseline prepared for this handoff: `0.81.182` (`Дашборд: чіткіший робочий режим`).
- Release `0.81.182` is the package baseline prepared in this handoff.
