...
check('Graduation diploma template is A4 portrait with park seal and no class-teacher signature', htmlContains('services/graduationDiplomas.js', '@page { size: A4 portrait; margin: 0; }') && htmlContains('services/graduationDiplomas.js', 'width: 210mm; height: 297mm') && htmlContains('services/graduationDiplomas.js', '/images/graduation/diploma-comic-template.png') && htmlContains('services/graduationDiplomas.js', '/images/park-logo.png') && !htmlContains('services/graduationDiplomas.js', 'Класний керівник'));
