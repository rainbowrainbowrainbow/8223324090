...
- Release package baseline prepared for this handoff: `0.80.159` (`HR Pool Status Cast Fix`).
...
- Release `0.80.159` is the package baseline prepared in this handoff. Reconfirm live version/commit before any future delivery or activation action.
