...
- Release package baseline prepared for this handoff: `0.82.2` (`Omni: сумісність зі старими зв’язками`).
- Release `0.82.2` is the package baseline prepared in this handoff.
