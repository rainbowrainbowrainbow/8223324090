...
### Managers (Admin)
```
GET    /api/v1/admin/managers             # List managers (ADMIN only)
POST   /api/v1/admin/managers             # Create/invite manager (ADMIN)
PUT    /api/v1/admin/managers/:id         # Update manager
DELETE /api/v1/admin/managers/:id         # Deactivate manager
```
...
GET    /api/v1/admin/settings/integrations # Integration statuses (Telegram, LiqPay)
```
