...
- Release package baseline prepared for this handoff: `0.82.18` (`Сертифікати: узгоджена перевірка та ізольований QA`).
- Release `0.82.18` is the package baseline prepared in this handoff.
