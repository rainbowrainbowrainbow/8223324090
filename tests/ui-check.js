...
checkPage('art-director.html', (doc, html) => {
    ...
    check('HR structure supports movable nodes and editable connector lines', hrCode.includes('DEFAULT_COMPANY_STRUCTURE_POSITIONS') && hrCode.includes('startCompanyOrgDrag') && hrCode.includes('renderCompanyOrgLinks') && hrCode.includes('startCompanyOrgLinkMode') && hrHtml.includes('id="hrOrgRelinkSelectedBtn"') && hrCode.includes('class="hr-org-link-layer"'));
    ...
    check('HR structure no longer leaks legacy animator shift summary below tabs', !hrHtml.includes('shiftsSummarySection') && !hrHtml.includes('loadShiftsSummary') && !hrHtml.includes('shiftsSummaryContainer'));
