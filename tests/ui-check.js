...
check('Sidebar status rail uses large custom icons and delayed descriptions', sidebarCode.includes('function _renderStatusIcon') && sidebarCode.includes('data-sidebar-tooltip') && sidebarCode.includes('function _initPillTooltips') && sidebarAuroraCss.includes('.sidebar-status-svg') && sidebarAuroraCss.includes('.sidebar-pill::after') && sidebarAuroraCss.includes('transition-delay: 0.46s'));
