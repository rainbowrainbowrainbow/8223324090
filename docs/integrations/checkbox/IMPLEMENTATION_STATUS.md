...
- Release package baseline prepared for this handoff: `0.82.9` (`SYS-MB: Майстерня, каталоги та telemetry`).
- Release `0.82.9` is the package baseline prepared in this handoff.
