...
- Release package baseline prepared for this handoff: `0.81.5` (`AI draft deprecation wrapper`).
...
- Release `0.81.5` is the package baseline prepared in this handoff. Reconfirm live version/commit before any future delivery or activation action.
